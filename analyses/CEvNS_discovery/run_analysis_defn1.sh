...
### Low contaminants plus neutrons
python3 ../create_simple_template_likelihood.py -c likelihood_configs/60t_1ty_LNGS_low_neutrons.ini -t PDFs/pdfs_CEvNS_disco_60t_good.pkl -o CEvNS_disco_60t_1ty_LNGS_good_low_neutrons
for exposure in 500 600 700 800 900 1000 1100 1200; do
    python3 ../discovery_no_scan/run_routine_discovery_no_scan.py -l likelihoods/CEvNS_disco_60t_1ty_LNGS_good_low_neutrons.pkl -e ${exposure} -c inference_configs/disco_study_neutrons.ini -o outputs/CEvNS_disco/LNGS_good_low_neutrons/60t_${exposure}ty
done
...
### Low contaminants plus neutrons
python3 ../create_simple_template_likelihood.py -c likelihood_configs/60t_1ty_SURF_low_neutrons.ini -t PDFs/pdfs_CEvNS_disco_60t_good.pkl -o CEvNS_disco_60t_1ty_SURF_good_low_neutrons
for exposure in 500 600 700 800 900 1000 1100 1200; do
    python3 ../discovery_no_scan/run_routine_discovery_no_scan.py -l likelihoods/CEvNS_disco_60t_1ty_SURF_good_low_neutrons.pkl -e ${exposure} -c inference_configs/disco_study_neutrons.ini -o outputs/CEvNS_disco/SURF_good_low_neutrons/60t_${exposure}ty
done
