python3 ../create_simple_template_likelihood.py -c likelihood_configs/60t_1ty_benchmark.ini -t PDFs/PMT_quantum_efficiency_0.31drift_field_80.00g1_gas_0.10gas_field_7.50.pkl -o WIMP_disco_60t_1ty_benchmark
