...
python3 ../create_simple_template_likelihood.py -c likelihood_configs/60t_1ty_benchmark.ini -t discovery_templates/2D/Pb214_${count}.pkl -o WIMP_disco_60t_1ty_benchmark_${count}
