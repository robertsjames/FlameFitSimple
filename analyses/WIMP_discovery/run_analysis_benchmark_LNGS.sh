...
python3 ../create_simple_template_likelihood.py -c likelihood_configs/likelihood_benchmark_${location} -t background_templates/3D_neutrons/3D_neutrons_${count}.pkl -o 3D_neutrons_${count}_${location}
for exposure in 50 100 150; do
